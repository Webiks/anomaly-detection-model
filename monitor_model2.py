...
with open (r'C:\Users\Tsabar\projects\monitor\json\test11.json') as json_file: X11=json.load(json_file)
with open (r'C:\Users\Tsabar\projects\monitor\json\test9.json') as json_file: X=json.load(json_file)
